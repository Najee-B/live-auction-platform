        ...
        <div class="col-md-6">
            ...
            <form action="{{ route('products.store') }}" enctype="multipart/form-data" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="starting_price" id="starting_price" step="0.01" class="form-control @error('starting_price') is-invalid @enderror" value="{{ old('starting_price') }}">
